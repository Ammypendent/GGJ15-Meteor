Shader "Custom/Texture Palette Specular"
{
	Properties
	{
	...
	SubShader
	{
		Pass
		{
			...
			float4 frag(vertexOutput input) : COLOR
			{
				...
				return float4(ambientLighting + (tex.rgb * diffuseReflection) + specularReflection, 1.0);
			}
		...
		Pass
		{
			...
			float4 frag(vertexOutput input) : COLOR
			{
				...
				return float4((tex.rgb * diffuseReflection) + specularReflection, 1.0);
			}
